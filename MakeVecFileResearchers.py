...
#########################
authornamenode = str(sys.argv[3])
authornamesarticleid = str(sys.argv[4])
data1 = pickle.load(open(authornamenode,'rb'));
data2 = pickle.load(open(authornamesarticleid,'rb'));
